...
(function() {
  var Gelfer, dgram, exports, msg, zlib,
  ...
  exports = module.exports = function(host, port, options) {
    return new Gelfer(host, port, options);
  };

  exports.Gelfer = Gelfer = (function() {
    var GELF_KEYS, HEADER_SIZE, ILLEGAL_KEYS;

    function Gelfer(host, port, options) {
      var _ref;
    ...
    Gelfer.prototype.send = function(data, callback) {
    ...
    Gelfer.prototype.encode = function(msg, callback) {
      var _this = this;
      if (callback == null) {
        callback = function() {};
      }
    ...
    Gelfer.prototype.split = function(data, chunkSize) {
    ...
    Gelfer.prototype.convert = function(msg) {
    ...
    Gelfer.prototype._newMsgId = function() {
      var msgId;
      msgId = new Buffer(8);
    ...
    Gelfer.prototype._getMaxChunkSize = function(size) {
      if (size == null) {
        size = 'wan';
      }
